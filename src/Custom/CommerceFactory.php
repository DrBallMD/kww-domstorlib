...
/**
 * Description of CommerceFlatFactory
 *
 * @author Dmitry Anikeev <da@kww.su>
 */
class Custom_CommerceFactory extends Custom_AbstractFactory
{
    ...
    {
        $builder = $this->getContainer()->get('form.builder.commerce');
        $builder->init(array(
    ...
    {
        $list_builder = $this->getContainer()->get('list.builder.commerce');
    ...
    public function createDetail(array $params)
    {
        ...
        $detail = $this->getContainer()->get('detail.commerce.'.$this->action);
